    ...
    <nav className="hidden fixed left-0 top-[80px] bg-[#FAFAFA] shadow-xl 
     ...
     lg:flex flex-col items-center z-40">
      ...
      <button 
        ...
        className='mt-auto mb-10 w-3/4 bg-[#4203a9] cursor-pointer text-white py-3 px-4 rounded-md font-medium hover:bg-[#4203a9]/90 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
      >
