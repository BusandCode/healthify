...
const HospitalCard = () => {
  return (
    ...
    <h1 className='font-semibold mb-4 text-[24px] sm:text-[20px] md:text-[30px] lg:text-[40px]
          text-[#4203a9]'>
        ...
        {hospitals.map((hospital) => (
          ...
          rounded-[25px] shadow border border-gray-200 overflow-hidden relative">
            <div className='max-w-[300px] mx-auto h-[566px] flex flex-col justify-center items-start'>
              ...
              <Bookmark className="w-[40px] h-[41.59px] absolute top-4 right-2 rounded-[25px] 
               bg-[#D9D9D9] text-[#0077CC] p-[12px]" size={25} />
            </div>
            <div className="p-4">
