...
const Page = () => {
  ...
  // Main Signup Page - shows after splash screen
  return (
    <section className='flex gap-[220px]'>
      ...
      <div className='flex max-w-fit  mx-auto md:mx-0 flex-col min-h-screen justify-center items-center px-5'>
        ...
        {/* <h1 className='flex md:hidden mb-8 bg-[#4203a9] max-w-[300px] w-full h-[45px] text-white text-[20px] py-3 px-3 rounded-tr-3xl rounded-bl-3xl items-center justify-center'>
          Welcome to Healthify
        </h1> */}
        ...
        <form className='flex flex-col gap-3 w-full max-w-[400px]'>
          ...
          <div>
            <button 
              className='bg-white border-[2px] border-gray-300 text-gray-700 w-full h-[50px] rounded-md text-[16px] cursor-pointer flex justify-center items-center hover:bg-gray-50 transition-colors duration-300'
            >
