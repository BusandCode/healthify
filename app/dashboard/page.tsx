...
import { FaUserMd, FaHospital, FaCalendarAlt, FaShieldAlt, FaMapMarkerAlt, FaHeartbeat, FaStar, FaSearch, FaRegCalendarCheck } from "react-icons/fa"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-6 relative">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative flex flex-col items-center text-center">
              <div className="relative z-10 w-14 h-14 bg-blue-50 border-4 border-white rounded-full flex items-center justify-center mb-5 shadow-sm">
                {step.icon}
              </div>
