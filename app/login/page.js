      ...
      <div className='flex flex-1 flex-col min-h-screen justify-center items-center px-4 sm:px-6 lg:px-8 py-8'>
        <div className='w-full max-w-[400px]'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div 
              onClick={handleLoad} 
              className='mt-2 bg-[#4203a9] cursor-pointer hover:bg-[#5a1bb8] active:bg-[#3a0287] transition-colors duration-300 text-white w-full h-[48px] sm:h-[55px] flex justify-center items-center rounded-md touch-manipulation'
            >
              {isLoad ? (
                <div className='w-6 h-6 sm:w-8 sm:h-8 border-3 sm:border-4 border-white border-t-transparent rounded-full animate-spin'></div>
              ) : (
                <button className='text-white text-[16px] sm:text-[18px] cursor-pointer font-semibold'>
                  Log In
                </button>
              )}
            </div>
            ...
            <div>
              <button className='bg-white border-[2px] border-gray-300 text-gray-700 w-full h-[48px] sm:h-[55px] rounded-md text-[14px] sm:text-[16px] cursor-pointer flex justify-center items-center hover:bg-gray-50 active:bg-gray-100 transition-colors duration-300 touch-manipulation'>
